  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-slate-900 to-blue-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <Swords
          className="absolute top-20 left-[15%] w-8 h-8 text-purple-400/20 animate-bounce"
          style={{ animationDuration: "3s" }}
        />
        <Shield
          className="absolute top-40 right-[20%] w-10 h-10 text-blue-400/20 animate-bounce"
          style={{ animationDuration: "4s", animationDelay: "0.5s" }}
        />
        <Trophy
          className="absolute bottom-32 left-[25%] w-9 h-9 text-yellow-400/20 animate-bounce"
          style={{ animationDuration: "3.5s", animationDelay: "1s" }}
        />
        <Zap
          className="absolute bottom-20 right-[15%] w-8 h-8 text-cyan-400/20 animate-bounce"
